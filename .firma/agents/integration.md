...
purpose: "Bewertet externe Tools (rtk, ruflo, graphify, etc.)"
...
outputs:
  - "docs/firma-os-audit/<date>-integration.md  (default)"
...
human_approval_required_for:
  ...
  - creating new package.json entries
...
## Mission
Bewertet externe Tools (rtk, ruflo, graphify, etc.)

## Trigger
- Manuell: `firma run integration`
...
```jsonl
{"real":"<ISO>","source":"agent:integration","tokens_in":N,"tokens_out":M,"run_id":"<uuid>"}
```
