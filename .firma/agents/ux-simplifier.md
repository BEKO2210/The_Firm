---
agent_id: ux-simplifier
purpose: "Macht das System für Anfänger bedienbar"
...
outputs:
  - "docs/firma-os-audit/<date>-ux-simplifier.md  (default)"
...
human_approval_required_for:
  - any write outside website/ or docs/
...
## Mission
Macht das System für Anfänger bedienbar

## Trigger
- Manuell: `firma run ux-simplifier`
...
```jsonl
{"real":"<ISO>","source":"agent:ux-simplifier","tokens_in":N,"tokens_out":M,"run_id":"<uuid>"}
```
