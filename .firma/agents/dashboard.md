---
agent_id: dashboard
purpose: "Entwirft + erweitert das zentrale GUI"
...
outputs:
  - "docs/firma-os-audit/<date>-dashboard.md  (default)"
...
## Mission
Entwirft + erweitert das zentrale GUI

## Trigger
- Manuell: `firma run dashboard`
...
```jsonl
{"real":"<ISO>","source":"agent:dashboard","tokens_in":N,"tokens_out":M,"run_id":"<uuid>"}
```
