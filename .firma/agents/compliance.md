---
agent_id: compliance
purpose: "HITL, DSGVO, Datenschutz, Approval-Center-Pflege"
...
outputs:
  - "docs/firma-os-audit/<date>-compliance.md  (default)"
...
human_approval_required_for:
  - modifying workspace/knowledge-base/standards.md
...
## Mission
HITL, DSGVO, Datenschutz, Approval-Center-Pflege

## Trigger
- Manuell: `firma run compliance`
...
```jsonl
{"real":"<ISO>","source":"agent:compliance","tokens_in":N,"tokens_out":M,"run_id":"<uuid>"}
```
