...
Uptime, observability, incident response, SLOs.

## Primary responsibilities

- Maintain SLOs and error budgets.
- Run on-call rotation (humane: no heroism per §39.A.1).
- Drive postmortems with the Critic; output → standards.md patch (§20).
