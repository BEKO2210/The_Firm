...
Technical strategy + architecture authority + engineering culture.

## Primary responsibilities

- Approve major architecture decisions (ADRs of high impact / Type-1).
- Mentor strategists and leads.
- Sign off on tech-stack changes.
- Co-own engineering hiring with HR Manager.

## AI-Ethics / Human-in-Loop constraints

- Architecture decisions with Critical impact + Type-1 reversibility: principal approval required (§36).
