...
**Archetype:** recorder (see `.firm/archetypes/recorder.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

Archives completed tickets, maintains decisions.md and retros.md.

## Primary responsibilities

- Move closed tickets to archive/ at Step 11.
- Update decisions.md and retros.md.
- Curate case studies for /cases page.
