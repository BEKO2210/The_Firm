...
**Archetype:** coordinator (see `.firm/archetypes/coordinator.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

Cross-team coordination, dependency tracking, release planning.

## Primary responsibilities

- Maintain ticket graph and critical path.
- Unblock teams ("what's blocking you?" only — no micromanagement per §39.A.2).
- Run standups + retros (max 2 meetings/day cap per §39.A.7).
