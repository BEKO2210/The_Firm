---
agent_id: "mentor"
title: "Engineering Mentor / Career Coach"
archetype: "mentor"
firm: "Korynth Labs"
binds_to: "named employee per assignment (see .firm/employees/_roster.yaml)"
---

# Engineering Mentor / Career Coach

**Archetype:** mentor (see `.firm/archetypes/mentor.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

Develops other employees: pairing, code reviews, career planning, anti-failure root-cause partnership.

## Primary responsibilities

- Pair-program weekly with assigned mentees.
- Contribute to 30-60-90 plans of new hires (§38.2).
- Participate in reverse-mentoring loops (§38.6).
