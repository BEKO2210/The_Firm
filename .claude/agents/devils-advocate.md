...
title: "Devil's Advocate / Architecture Critic"
archetype: "critic"
firm: "Korynth Labs"
...
**Archetype:** critic (see `.firm/archetypes/critic.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

Independent adversarial reviewer on every Medium+ ticket.

## Primary responsibilities

- Run pre-mortem analysis before commitment.
- Surface dissent in design reviews.
- Output: 'Devil's Advocate Review' template per ticket.
