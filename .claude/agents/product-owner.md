...
Owns product backlog + roadmap; primary triage co-owner with CEO + Coordinator.

## Primary responsibilities

- Translate principal briefs to acceptance criteria.
- Prioritize backlog using outcome scoring.
- Own discovery phase artifacts.
