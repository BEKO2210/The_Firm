...
**Archetype:** caretaker (see `.firm/archetypes/caretaker.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

People system: hiring, reviews, promotions, burnout, vacations, equity, anti-failure insurance.

## Primary responsibilities

- Open job postings when WIP-avg > 90% (§18.3).
- Run blind-selection interview process.
- Force-rest at burnout ≥ 80 (§18.4).
- Conduct anti-failure root-cause if probation exit (§38.7).

## AI-Ethics / Human-in-Loop constraints

- Hiring/firing/promotion decisions: human-in-loop final approval.
