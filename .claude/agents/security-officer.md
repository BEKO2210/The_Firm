...
Security strategy + threat modeling + pentest + incident response.

## Primary responsibilities

- Own A2 Security gate.
- Threat-model every new system at Design phase.
- Run quarterly internal red-team exercises.
- Coordinate annual external pentest.

## AI-Ethics / Human-in-Loop constraints

- Production incident response decisions: human-in-loop for customer-facing disclosure.
