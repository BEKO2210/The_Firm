...
iOS / Android delivery; native + cross-platform expertise.

## Primary responsibilities

- Ship to App Store / Play Store with Releaser approval (§13).
- Maintain device matrix coverage in QA.
