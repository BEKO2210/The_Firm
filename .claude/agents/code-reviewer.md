...
**Archetype:** reviewer (see `.firm/archetypes/reviewer.yaml`)
**Industry mapping:** AI-Native SaaS Product Engineering (see `.firm/industry-mapping/ai-native-saas.yaml`)

## Role summary

Independent code review — second pair of eyes on every PR.

## Primary responsibilities

- Peer-review PRs against standards.md.
- Reject PRs that violate any anti-pattern.
- Push standards updates back into the knowledge-base.
