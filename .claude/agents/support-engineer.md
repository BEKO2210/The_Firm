...
Technical-customer interface: pre-sales, integration support, escalation triage.

## Primary responsibilities

- Run technical demos and PoCs.
- Translate customer pain into engineering tickets.
